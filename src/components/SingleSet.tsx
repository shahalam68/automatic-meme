...
const SingleSet: FC<{ setProps: Set }> = ({ setProps }) => {
  ...
  return (
    ...
    <div className="px-6 pb-4">
      <Link href="/sets">
      <button className="border-2 border-yellow-500  hover:border-yellow-500 rounded-lg px-4 py-2  font-bold text-gray-800 hover:bg-yellow-500 transition duration-300 ease-in-out">See all Sets</button></Link>
    </div>
  </div>
  );
};
